import { View, TextInputProps, TextInput, Pressable, useColorScheme } from 'react-native'
...
const ThemedTextInputPassword = ({ icon, focusedInput, onFocus, onBlur, setInputRef, numero, ...rest }: Props) => {
    ...
    return (
        ...
        >
            ...
            <Pressable onPress={() => setShowPassword(!showPassword)}>
                <Ionicons name={!showPassword ? 'eye-off' : 'eye'} size={24} color={focusedInput === numero ? primaryColor : color} />
            </Pressable>
        </View>
    )
}

export default ThemedTextInputPassword